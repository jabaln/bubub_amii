...
const messages = [
    "Tap dimana aja sayanggg",
    "HAALOOOO SAYANGG",
    "Aku mau ngomong sesuatu nih",
    "Coba pencet",
    "Pencet lagi",
    "Ayo semangaaatt mencetnyaaa ayy",
    "Janji ini terakhir",
    "Serius",
    "Ini",
    "Terakhir",
    "Tapi bohong hehe yahaha hayyuk pappalepale",
    "Aku tau pasti kamu kesal mwhehe maafkan aku",
    "Heumm",
    "Yaudah deh",
    "Padahal",
    "Aku cuma mau bilang",
    ...
    "LOVE U BANYAK BANYAK, Pindah ke link selanjutnya ya pencet yang dibawah"
];
